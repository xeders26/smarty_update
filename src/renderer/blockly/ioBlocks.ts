/*================
  src/renderer/blockly/ioBlocks.ts
=================*/
...
export function initIoBlocks(arduinoGenerator: any) {
  ...
  // ==========================================
   ...
   Blockly.Blocks['arduino_digital_write'] = { init: function(this: any) { this.appendDummyInput().appendField("디지털 핀").appendField(new Blockly.FieldNumber(13, 0, 100), "PIN").appendField("번을"); this.appendDummyInput().appendField(new Blockly.FieldDropdown([["켜기(HIGH)", "HIGH"],["끄기(LOW)", "LOW"]]), "STATE").appendField("상태로 만들기"); this.setPreviousStatement(true, null); this.setNextStatement(true, null); this.setColour(160); } };
  Blockly.Blocks['arduino_pin_mode'] = { init: function(this: any) { this.appendDummyInput().appendField("디지털 핀").appendField(new Blockly.FieldNumber(13, 0, 100), "PIN").appendField("번을"); this.appendDummyInput().appendField(new Blockly.FieldDropdown([["출력(OUTPUT)", "OUTPUT"],["입력(INPUT)", "INPUT"]]), "MODE").appendField("모드로 설정"); this.setPreviousStatement(true, null); this.setNextStatement(true, null); this.setColour(160); } };
  ...
  Blockly.Blocks['arduino_analog_read'] = { init: function(this: any) { this.appendDummyInput().appendField("아날로그 핀").appendField(new Blockly.FieldDropdown([["A0","A0"],["A1","A1"],["A2","A2"],["A3","A3"],["A4","A4"],["A5","A5"]]), "PIN").appendField("읽기"); this.setOutput(true, "Number"); this.setColour(160); } };
