...
export function initSensorBlocks(arduinoGenerator: any) {
  ...
  Blockly.defineBlocksWithJsonArray([
    ...
    { "type": "waitUntilAdc", "message0": "아날로그 대기 CH: %1 조건: %2 값: %3", "args0":[ {"type": "field_dropdown", "name": "CH", "options": [["A1", "A1"],["A2", "A2"],["A3", "A3"],["A4", "A4"],["A5", "A5"],["A6", "A6"],["A7", "A7"],["A8", "A8"]]}, {"type": "field_dropdown", "name": "COM", "options": [["==", "\"==\""],[">", "\">\""],[">=", "\">=\""],["<", "\"<\""],["<=", "\"<=\""]]}, {"type": "input_value", "name": "VAL", "check": "Number"} ], "previousStatement": null, "nextStatement": null, "colour": 120 },
    ...
    { "type": "getSw", "message0": "스위치 눌림 확인(시간) ID: %1 대기시간(ms): %2", "args0":[ {"type": "field_dropdown", "name": "ID", "options": [["SW1", "SW1"],["SW2", "SW2"]]}, {"type": "input_value", "name": "INTERVAL", "check": "Number"} ], "output": "Boolean", "colour": 60 },
